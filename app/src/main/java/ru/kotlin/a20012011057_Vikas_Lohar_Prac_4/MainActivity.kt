package ru.kotlin.a20012011057_Vikas_Lohar_Prac_4
...
import ru.kotlin.a20012011057_Vikas_Lohar_Prac_4.R
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var input_browse = findViewById<TextInputEditText>(R.id.input_browse)
        buttonBrowse.setOnClickListener{
            val url = input_browse.text
            var url_text = url.toString()
            Intent(android.content.Intent.ACTION_VIEW).setData(Uri.parse("www.google.com")).apply { startActivity(this) } }
